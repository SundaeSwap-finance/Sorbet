...
export const createAddressMenu = (): ShowAddressMenuFn => {
  ...
  let addressMenu: HTMLDivElement,
    setAddressButton: HTMLButtonElement,
    addToAddressBookButton: HTMLButtonElement,
    originalLinkButton: HTMLButtonElement;
  const ADDRESS_MENU_ID = "sorbet_address_menu";
  const ADDRESS_MENU_SET_ADDRESS_BUTTON_ID = "sorbet_address_menu_set_address_button";
  const ADDRESS_MENU_ADD_TO_ADDRESS_BOOK_BUTTON_ID =
    "sorbet_address_menu_add_to_addressbook_button";
  ...
  if (foundAddressMenu) {
    ...
    addToAddressBookButton = createMenuButton(
      ADDRESS_MENU_ADD_TO_ADDRESS_BOOK_BUTTON_ID,
      "Add to Address Book",
      (_e) => {
    ...
    originalLinkButton = createMenuButton(
      ADDRESS_MENU_ORIGINAL_LINK_BUTTON_ID,
    ...
    document.onclick = (e) => {
      if (e.target instanceof HTMLElement) {
        if (
          e.target.className !== SORBET_ADDRESS_ANNOTATION_CLASSNAME &&
